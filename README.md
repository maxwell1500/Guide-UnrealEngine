...
![GitHub Repository stars](https://img.shields.io/github/stars/MrRobinOfficial/Guide-UnrealEngine)
...
_This repository covers Unreal Engine C++ fundamentals, including core programming concepts like data types and pointers within a game development context. You'll learn the Unreal module system for organizing code into manageable, reusable components._
...
> [!TIP]
> If you want to use **C#** as the main scripting language, then check out this [repository by Oscar Olsson](https://github.com/UnrealSharp/UnrealSharp).
...
- [🎩 Plugins](#🎩-plugins)
  ...
  - [MrRobinOfficial's Plugins](#mrrobinofficial's-plugins)
- [📛 Console Commands](#📛-console-commands)
- [📌 Shortcuts](#📌-shortcuts)
- [⌛ Getting started with C++](#⌛-getting-started-with-c++)
  - [🌈 Integrated Development Environment](#🌈-integrated-development-environment)
  - [⛏️ Tools to help your journey](#⛏️-tools-to-help-your-journey)
...
- [🎪 Architecture](#🎪-architecture)
  - [List Of Essential Classes](#list-of-essential-classes)
    - [Object](#object)
    - [Actor](#actor)
    ...
    - [Actor Component](#actor-component)
      - [List Of Essential Components](#list-of-essential-components)
      - [Helpful Functions](#helpful-functions)
    - [Subsystem](#subsystem)
    - [Blueprint Function Library](#blueprint-function-library)
    - [Engine](#engine)
    - [Game Viewport Client](#game-viewport-client)
    ...
    - [Primary Data Asset](#primary-data-asset)
      - [Helpful Functions](#helpful-functions)
    - [Sound Base](#sound-base)
    - [Material](#material)
    - [Material Instance](#material-instance)
    - [Material Instance Dynamic](#material-instance-dynamic)
    - [Texture](#texture)
    - [Texture2D](#texture2d)
    - [Field](#field)
    - [Struct](#struct)
    - [Class](#class)
  - [More About Unreal Architecture](#more-about-unreal-architecture)
...
- [📚 Create custom module](#📚-create-custom-module)
  ...
  - [♻️ Circular Dependency](#♻️-circular-dependency)
...
- [🐣 Tips and best practices](#🐣-tips-and-best-practices)
  ...
  - [⏱ Ticking](#⏱-ticking)
    ...
    - [`FTickFunction`](#`ftickfunction`)
      - [MyTickableThing.h](#mytickablething.h)
      - [MyTickableThing.cpp](#mytickablething.cpp)
